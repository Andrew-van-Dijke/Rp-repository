...
"get target"
print("Please set the target and type y/n to continue::\n")
S1 = input()
...
for step in range(Nsteps):
    for target in range(Ntarget):
        ...
        DI = get_angles(
            dev_sorted
        )  # measure and record the angular displacement #---------------------------------------------------
